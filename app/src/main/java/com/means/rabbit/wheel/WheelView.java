package com.means.rabbit.wheel;
...
import com.means.rabbit.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private int[] SHADOWS_COLORS = new int[]{0xeFFFFFF, 0xcFFFFFF, 0x3FFFFFF};
    // Wheel Values
...
//		paint.setColor(getResources().getColor(R.color.province_line_border));
        paint.setColor(getResources().getColor(R.color.wheel_dialog_blue));
        // 设置线宽
